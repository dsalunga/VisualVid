<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Register.aspx.cs" Inherits="Register" ValidateRequest="false" %>
                                    ...
                                    <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="field">
                                                ...
                                                agree to the <a href="#">terms of use</a> and <a href="#">privacy policy</a>.</div>
                                            <br>
                                            <div>
                                                <div>
                                    ...
                                    <asp:CompleteWizardStep ID="CompleteWizardStep1" runat="server">
                                        <ContentTemplate>
                                            <table cellpadding="0" cellspacing="0" border="0" align="center">
                                                ...
                                                <tr>
                                                    <td>
                                                        Your account has been successfully created. Please check your email and click the
                                                        finish button to login.</td>
                                                </tr>
                                                <tr>
